...
What came back wasn't a clean leaderboard. It was five separate places where the obvious answer — the vendor recommendation, the model I was already trusting to grade the others — turned out to be wrong, plus a sixth on the Pi I'll get to in that section below.
